...
def menuprincipal():
   ...
   #Police des boutons textes
    ...
    fond = pygame.image.load("image/backgrounds/backgroundmenu1.png").convert()
   ...
   #Police des boutons textes
    ...
    #Boutons retour (1) et suivant (2)
     ...
     # 1) Voici le bouton retour, et son cadre :
        pygame.draw.rect(fenetre,couleur_retour, (20,400,180,55), 0) # avec : x,y, longueur, Epaisseur
        pygame.draw.rect(fenetre,(255,255,255), (20,400,180,55), 2)
    ...
    # Et voici le texte :
        ...
        textpos.centery = fond.get_rect().centery
        fond.blit(text, textpos)
        fenetre.blit(text, (48,410))

    # 2) Voici le bouton suivant, et son cadre:
        pygame.draw.rect(fenetre,couleur_suivant, (430,400,180,55), 0) # avec : x,y, longueur, Epaisseur
        pygame.draw.rect(fenetre,(255,255,255), (430,400,180,55), 2)
...
#---------------------------
        ...
        for event in pygame.event.get():
            ...
            if event.type == MOUSEMOTION:
                ...
                if (event.pos[0] >= 20)  and (event.pos[0]<= 200) and (event.pos[1] >= 400)  and (event.pos[1] <= 455) :
                    couleur_retour = (127,35,128)

                elif (event.pos[0] >= 430)  and (event.pos[0]<= 710) and (event.pos[1] >= 400)  and (event.pos[1] <= 455) :
    ...
    #Rangée 2 88 devient 238 (+150 en y)
...
#----------------
                #bouton retour
                elif (event.pos[0] >= 20)  and (event.pos[0]<= 200) and (event.pos[1] >= 400)  and (event.pos[1] <= 455):
                    menu = 1
                    return menu
                #bouton suivant
                elif (event.pos[0] >= 430)  and (event.pos[0]<= 610) and (event.pos[1] >= 400)  and (event.pos[1] <= 455):
                    menu = 4
                    return menu
#----------------
